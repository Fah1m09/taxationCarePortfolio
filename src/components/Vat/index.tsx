          ...
          <div className="w-full space-y-12 px-4">
            <table className="w-full">
              ...
              <tbody className="mt-[30px]">
                {vatData.map((vat) => (
                  <tr key={vat.id} className="cursor-pointer">
                    <td className="px-4 py-2">{vat.id}</td>
                    <td className="px-4 py-2">{vat.title}</td>
                    <td className="px-4 py-2">{vat.date}</td>
                    <td className="px-4 py-2">
                      <Link href={vat?.link} passHref={true} target="_blank">
                        <Image
