    ...
    <div className="relative z-10 rounded-sm bg-white p-8 shadow-three dark:bg-gray-dark sm:p-11 lg:p-8 xl:p-11">
      ...
      <div className="space-y-10">
        <div className="flex items-start gap-4">
          <Image
            src="/images/contact/phone_dark.svg"
            alt="callIcon"
          ...
          />
          <Image
            src="/images/contact/phone_light.svg"
            alt="callIcon"
          ...
          />
          <div className="pt-1">
            <h3 className="headingText">Call</h3>
            <p className="paragraphText">+ 880 1972185238</p>
            <p className="paragraphText">+ 880 1618733108</p>
          </div>
        </div>

        <div className="flex items-start gap-4">
          <Image
            src="/images/contact/email_dark.svg"
            alt="emailIcon"
            className="dark:hidden"
            width={40}
            height={30}
          />
          <Image
            src="/images/contact/email_light.svg"
            alt="emailIcon"
            className="hidden dark:block"
            width={40}
            height={30}
          />
          <div className="pt-1">
            <h3 className="headingText">Email</h3>
            <p className="paragraphText">taxationcarebd@gmail.com</p>
            <p className="paragraphText">haque7343@gmail.com</p>
          </div>
        </div>

        <div className="flex items-start gap-4">
          <Image
            src="/images/contact/location_dark.svg"
            alt="locationIcon"
            className="dark:hidden"
            width={40}
            height={30}
          />
          <Image
            src="/images/contact/location_light.svg"
            alt="locationIcon"
            className="hidden dark:block"
            width={40}
            height={30}
          />
          <div className="pt-1">
            <h3 className="headingText">Our Location</h3>
            <p className="paragraphText">
              House: 321, Road: 15, Block: K, South Banasree, Dhaka 1219,
              Bangladesh
            </p>
          </div>
        </div>
